...
\caption{På figuren ses den simplificerede state machine for Kontrolinterfacet. En mere detaljeret kan ses i designdokumentationen for Kontrolinterfacet}
\end{figure}
