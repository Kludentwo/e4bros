...
3b &Ved indtastning af forkert adgangskode bliver brugeren ikke logget på og bedt om indtastning af adgangskode igen   & Ved forkert adgangskode blev brugeren sendt til en blank side men kan ikke få adgang til data &\begin{Huge}$\surd$\end{Huge} \\\hline
