...
3 &At teste udgangsspænding 12V ved 1A og 5V samtidig &Der måles direkte på 12V og 5V udgangen samtidig med et voltmeter, med effekt load modstand der svare til at der vil blive trukket 1A på 12V udgangen og 0.5A på 5V udgangen. \\\hline
\end{tabular}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% SOFTWARE                   %%%
...
\hline
Case &Forventet resultat &Resultat &Status\\\hline
1a &12V spændingen ligger på stabilt 12V &-- & \\\hline %\begin{Huge}$\surd$\end{Huge}
1b &12V spændingen ligger lidt under 12V, komponenter på strømforsyningen bliver varme &-- & \\\hline %\begin{Huge}$\surd$\end{Huge}
1c &12V spændingen ligger lidt under 12V, komponenter på strømforsyningen bliver meget varme &-- & \\\hline %\begin{Huge}$\surd$\end{Huge}
2a &5V spændingen ligger på stabilt 5V &-- & \\\hline %\begin{Huge}$\surd$\end{Huge}
2b &5V spændingen ligger lidt under 5V, komponenter på strømforsyningen bliver varme &-- &  \\\hline %\begin{Huge}$\surd$\end{Huge}
2c &5V spændingen ligger lidt under 5V, komponenter på strømforsyningen bliver meget varme &-- &  \\\hline %\begin{Huge}$\surd$\end{Huge}
