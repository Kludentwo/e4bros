...
\usepackage{listings}						% code i latex
																			
% ¤¤ Figurer og tabeller (floats) ¤¤ %
\usepackage{graphicx} 	
\usepackage{longtable}					% Haandtering af eksterne billeder (JPG, PNG, EPS, PDF)
...
\makeevenhead{IHA}{BROS}{}{\leftmark}				% Definerer lige siders sidehoved (\makeevenhead{Navn}{Venstre}{Center}{Hoejre})
\makeoddhead{IHA}{\rightmark}{}{Engineering College of Aarhus}		% Definerer ulige siders sidehoved (\makeoddhead{Navn}{Venstre}{Center}{Hoejre})
